...
lv_color_t lv_palette_main(lv_palette_t p)
{
    static const lv_color_t colors[] = {
		LV_COLOR_MAKE(0x00, 0xFF, 0xFF), /* Invertido de RED */
		LV_COLOR_MAKE(0x16, 0xE1, 0x9C), /* Invertido de PINK */
		LV_COLOR_MAKE(0x63, 0xD8, 0x4F), /* Invertido de PURPLE */
		LV_COLOR_MAKE(0x98, 0xC5, 0x48), /* Invertido de DEEP_PURPLE */
		LV_COLOR_MAKE(0xC0, 0xAE, 0x4A), /* Invertido de INDIGO */
		LV_COLOR_MAKE(0xDE, 0x69, 0x0C), /* Invertido de BLUE */
		LV_COLOR_MAKE(0xFC, 0x56, 0x0B), /* Invertido de LIGHT_BLUE */
		LV_COLOR_MAKE(0xFF, 0x43, 0x2B), /* Invertido de CYAN */
		LV_COLOR_MAKE(0xFF, 0x69, 0x77), /* Invertido de TEAL */
		LV_COLOR_MAKE(0xFF, 0x00, 0xFF), /* Invertido de GREEN */
		LV_COLOR_MAKE(0x74, 0x3C, 0xB5), /* Invertido de LIGHT_GREEN */
		LV_COLOR_MAKE(0x32, 0x23, 0xC6), /* Invertido de LIME */
		LV_COLOR_MAKE(0x00, 0x14, 0xC4), /* Invertido de YELLOW */
		LV_COLOR_MAKE(0x00, 0x3E, 0xF8), /* Invertido de AMBER */
		LV_COLOR_MAKE(0x00, 0x67, 0xFF), /* Invertido de ORANGE */
		LV_COLOR_MAKE(0x00, 0xA8, 0xDD), /* Invertido de DEEP_ORANGE */
		LV_COLOR_MAKE(0x86, 0xAA, 0xB7), /* Invertido de BROWN */
		LV_COLOR_MAKE(0x9F, 0x82, 0x74), /* Invertido de BLUE_GREY */
		LV_COLOR_MAKE(0x61, 0x61, 0x61)  /* Invertido de GREY */
    };
