...
static inline lv_color_t lv_color_black(void) { return lv_color_make(0xff, 0xff, 0xff);}
static inline lv_color_t lv_color_white(void) { return lv_color_make(0x00, 0x0, 0x00);}
