...
C_SRCS += \
../lvgl-8.3.10/src/draw/lv_draw.c \
../lvgl-8.3.10/src/draw/lv_draw_arc.c \
../lvgl-8.3.10/src/draw/lv_draw_img.c \
../lvgl-8.3.10/src/draw/lv_draw_label.c \
../lvgl-8.3.10/src/draw/lv_draw_layer.c \
../lvgl-8.3.10/src/draw/lv_draw_line.c \
../lvgl-8.3.10/src/draw/lv_draw_mask.c \
../lvgl-8.3.10/src/draw/lv_draw_rect.c \
../lvgl-8.3.10/src/draw/lv_draw_transform.c \
../lvgl-8.3.10/src/draw/lv_draw_triangle.c \
../lvgl-8.3.10/src/draw/lv_img_buf.c \
../lvgl-8.3.10/src/draw/lv_img_cache.c \
../lvgl-8.3.10/src/draw/lv_img_decoder.c 

C_DEPS += \
./lvgl-8.3.10/src/draw/lv_draw.d \
./lvgl-8.3.10/src/draw/lv_draw_arc.d \
./lvgl-8.3.10/src/draw/lv_draw_img.d \
./lvgl-8.3.10/src/draw/lv_draw_label.d \
./lvgl-8.3.10/src/draw/lv_draw_layer.d \
./lvgl-8.3.10/src/draw/lv_draw_line.d \
./lvgl-8.3.10/src/draw/lv_draw_mask.d \
./lvgl-8.3.10/src/draw/lv_draw_rect.d \
./lvgl-8.3.10/src/draw/lv_draw_transform.d \
./lvgl-8.3.10/src/draw/lv_draw_triangle.d \
./lvgl-8.3.10/src/draw/lv_img_buf.d \
./lvgl-8.3.10/src/draw/lv_img_cache.d \
./lvgl-8.3.10/src/draw/lv_img_decoder.d 

OBJS += \
./lvgl-8.3.10/src/draw/lv_draw.o \
./lvgl-8.3.10/src/draw/lv_draw_arc.o \
./lvgl-8.3.10/src/draw/lv_draw_img.o \
./lvgl-8.3.10/src/draw/lv_draw_label.o \
./lvgl-8.3.10/src/draw/lv_draw_layer.o \
./lvgl-8.3.10/src/draw/lv_draw_line.o \
./lvgl-8.3.10/src/draw/lv_draw_mask.o \
./lvgl-8.3.10/src/draw/lv_draw_rect.o \
./lvgl-8.3.10/src/draw/lv_draw_transform.o \
./lvgl-8.3.10/src/draw/lv_draw_triangle.o \
./lvgl-8.3.10/src/draw/lv_img_buf.o \
./lvgl-8.3.10/src/draw/lv_img_cache.o \
./lvgl-8.3.10/src/draw/lv_img_decoder.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/src/draw/%.o: ../lvgl-8.3.10/src/draw/%.c lvgl-8.3.10/src/draw/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-src-2f-draw

clean-lvgl-2d-8-2e-3-2e-10-2f-src-2f-draw:
	-$(RM) ./lvgl-8.3.10/src/draw/lv_draw.d ./lvgl-8.3.10/src/draw/lv_draw.o ./lvgl-8.3.10/src/draw/lv_draw_arc.d ./lvgl-8.3.10/src/draw/lv_draw_arc.o ./lvgl-8.3.10/src/draw/lv_draw_img.d ./lvgl-8.3.10/src/draw/lv_draw_img.o ./lvgl-8.3.10/src/draw/lv_draw_label.d ./lvgl-8.3.10/src/draw/lv_draw_label.o ./lvgl-8.3.10/src/draw/lv_draw_layer.d ./lvgl-8.3.10/src/draw/lv_draw_layer.o ./lvgl-8.3.10/src/draw/lv_draw_line.d ./lvgl-8.3.10/src/draw/lv_draw_line.o ./lvgl-8.3.10/src/draw/lv_draw_mask.d ./lvgl-8.3.10/src/draw/lv_draw_mask.o ./lvgl-8.3.10/src/draw/lv_draw_rect.d ./lvgl-8.3.10/src/draw/lv_draw_rect.o ./lvgl-8.3.10/src/draw/lv_draw_transform.d ./lvgl-8.3.10/src/draw/lv_draw_transform.o ./lvgl-8.3.10/src/draw/lv_draw_triangle.d ./lvgl-8.3.10/src/draw/lv_draw_triangle.o ./lvgl-8.3.10/src/draw/lv_img_buf.d ./lvgl-8.3.10/src/draw/lv_img_buf.o ./lvgl-8.3.10/src/draw/lv_img_cache.d ./lvgl-8.3.10/src/draw/lv_img_cache.o ./lvgl-8.3.10/src/draw/lv_img_decoder.d ./lvgl-8.3.10/src/draw/lv_img_decoder.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-src-2f-draw
