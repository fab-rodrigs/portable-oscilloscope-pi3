...
C_SRCS += \
../lvgl-8.3.10/tests/src/lv_test_indev.c \
../lvgl-8.3.10/tests/src/lv_test_init.c 

C_DEPS += \
./lvgl-8.3.10/tests/src/lv_test_indev.d \
./lvgl-8.3.10/tests/src/lv_test_init.d 

OBJS += \
./lvgl-8.3.10/tests/src/lv_test_indev.o \
./lvgl-8.3.10/tests/src/lv_test_init.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/tests/src/%.o: ../lvgl-8.3.10/tests/src/%.c lvgl-8.3.10/tests/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-src

clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-src:
	-$(RM) ./lvgl-8.3.10/tests/src/lv_test_indev.d ./lvgl-8.3.10/tests/src/lv_test_indev.o ./lvgl-8.3.10/tests/src/lv_test_init.d ./lvgl-8.3.10/tests/src/lv_test_init.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-src
