...
C_SRCS += \
../lvgl-8.3.10/tests/unity/unity.c \
../lvgl-8.3.10/tests/unity/unity_support.c 

C_DEPS += \
./lvgl-8.3.10/tests/unity/unity.d \
./lvgl-8.3.10/tests/unity/unity_support.d 

OBJS += \
./lvgl-8.3.10/tests/unity/unity.o \
./lvgl-8.3.10/tests/unity/unity_support.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/tests/unity/%.o: ../lvgl-8.3.10/tests/unity/%.c lvgl-8.3.10/tests/unity/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-unity

clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-unity:
	-$(RM) ./lvgl-8.3.10/tests/unity/unity.d ./lvgl-8.3.10/tests/unity/unity.o ./lvgl-8.3.10/tests/unity/unity_support.d ./lvgl-8.3.10/tests/unity/unity_support.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-tests-2f-unity
