...
C_SRCS += \
../lvgl-8.3.10/examples/porting/lv_port_disp_template.c \
../lvgl-8.3.10/examples/porting/lv_port_fs_template.c \
../lvgl-8.3.10/examples/porting/lv_port_indev_template.c 

C_DEPS += \
./lvgl-8.3.10/examples/porting/lv_port_disp_template.d \
./lvgl-8.3.10/examples/porting/lv_port_fs_template.d \
./lvgl-8.3.10/examples/porting/lv_port_indev_template.d 

OBJS += \
./lvgl-8.3.10/examples/porting/lv_port_disp_template.o \
./lvgl-8.3.10/examples/porting/lv_port_fs_template.o \
./lvgl-8.3.10/examples/porting/lv_port_indev_template.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/porting/%.o: ../lvgl-8.3.10/examples/porting/%.c lvgl-8.3.10/examples/porting/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-porting

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-porting:
	-$(RM) ./lvgl-8.3.10/examples/porting/lv_port_disp_template.d ./lvgl-8.3.10/examples/porting/lv_port_disp_template.o ./lvgl-8.3.10/examples/porting/lv_port_fs_template.d ./lvgl-8.3.10/examples/porting/lv_port_fs_template.o ./lvgl-8.3.10/examples/porting/lv_port_indev_template.d ./lvgl-8.3.10/examples/porting/lv_port_indev_template.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-porting
