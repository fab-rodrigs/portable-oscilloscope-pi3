...
C_SRCS += \
../lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_1.c \
../lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_2.c \
../lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_approve.c 

C_DEPS += \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_1.d \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_2.d \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_approve.d 

OBJS += \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_1.o \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_2.o \
./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_approve.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/libs/rlottie/%.o: ../lvgl-8.3.10/examples/libs/rlottie/%.c lvgl-8.3.10/examples/libs/rlottie/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-libs-2f-rlottie

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-libs-2f-rlottie:
	-$(RM) ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_1.d ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_1.o ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_2.d ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_2.o ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_approve.d ./lvgl-8.3.10/examples/libs/rlottie/lv_example_rlottie_approve.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-libs-2f-rlottie
