...
C_SRCS += \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_1.c \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_2.c \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_3.c \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_4.c \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_5.c \
../lvgl-8.3.10/examples/layouts/grid/lv_example_grid_6.c 

C_DEPS += \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_1.d \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_2.d \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_3.d \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_4.d \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_5.d \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_6.d 

OBJS += \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_1.o \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_2.o \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_3.o \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_4.o \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_5.o \
./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_6.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/layouts/grid/%.o: ../lvgl-8.3.10/examples/layouts/grid/%.c lvgl-8.3.10/examples/layouts/grid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-layouts-2f-grid

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-layouts-2f-grid:
	-$(RM) ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_1.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_1.o ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_2.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_2.o ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_3.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_3.o ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_4.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_4.o ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_5.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_5.o ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_6.d ./lvgl-8.3.10/examples/layouts/grid/lv_example_grid_6.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-layouts-2f-grid
