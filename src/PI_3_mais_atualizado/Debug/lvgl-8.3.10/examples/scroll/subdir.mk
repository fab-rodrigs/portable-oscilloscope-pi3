...
C_SRCS += \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_1.c \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_2.c \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_3.c \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_4.c \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_5.c \
../lvgl-8.3.10/examples/scroll/lv_example_scroll_6.c 

C_DEPS += \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_1.d \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_2.d \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_3.d \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_4.d \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_5.d \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_6.d 

OBJS += \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_1.o \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_2.o \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_3.o \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_4.o \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_5.o \
./lvgl-8.3.10/examples/scroll/lv_example_scroll_6.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/scroll/%.o: ../lvgl-8.3.10/examples/scroll/%.c lvgl-8.3.10/examples/scroll/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-scroll

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-scroll:
	-$(RM) ./lvgl-8.3.10/examples/scroll/lv_example_scroll_1.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_1.o ./lvgl-8.3.10/examples/scroll/lv_example_scroll_2.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_2.o ./lvgl-8.3.10/examples/scroll/lv_example_scroll_3.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_3.o ./lvgl-8.3.10/examples/scroll/lv_example_scroll_4.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_4.o ./lvgl-8.3.10/examples/scroll/lv_example_scroll_5.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_5.o ./lvgl-8.3.10/examples/scroll/lv_example_scroll_6.d ./lvgl-8.3.10/examples/scroll/lv_example_scroll_6.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-scroll
