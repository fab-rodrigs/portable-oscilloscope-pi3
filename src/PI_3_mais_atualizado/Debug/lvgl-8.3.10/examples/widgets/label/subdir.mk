...
C_SRCS += \
../lvgl-8.3.10/examples/widgets/label/lv_example_label_1.c \
../lvgl-8.3.10/examples/widgets/label/lv_example_label_2.c \
../lvgl-8.3.10/examples/widgets/label/lv_example_label_3.c \
../lvgl-8.3.10/examples/widgets/label/lv_example_label_4.c \
../lvgl-8.3.10/examples/widgets/label/lv_example_label_5.c 

C_DEPS += \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_1.d \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_2.d \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_3.d \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_4.d \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_5.d 

OBJS += \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_1.o \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_2.o \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_3.o \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_4.o \
./lvgl-8.3.10/examples/widgets/label/lv_example_label_5.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/widgets/label/%.o: ../lvgl-8.3.10/examples/widgets/label/%.c lvgl-8.3.10/examples/widgets/label/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-label

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-label:
	-$(RM) ./lvgl-8.3.10/examples/widgets/label/lv_example_label_1.d ./lvgl-8.3.10/examples/widgets/label/lv_example_label_1.o ./lvgl-8.3.10/examples/widgets/label/lv_example_label_2.d ./lvgl-8.3.10/examples/widgets/label/lv_example_label_2.o ./lvgl-8.3.10/examples/widgets/label/lv_example_label_3.d ./lvgl-8.3.10/examples/widgets/label/lv_example_label_3.o ./lvgl-8.3.10/examples/widgets/label/lv_example_label_4.d ./lvgl-8.3.10/examples/widgets/label/lv_example_label_4.o ./lvgl-8.3.10/examples/widgets/label/lv_example_label_5.d ./lvgl-8.3.10/examples/widgets/label/lv_example_label_5.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-label
