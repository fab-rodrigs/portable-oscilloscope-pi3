...
C_SRCS += \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_1.c \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_2.c \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_3.c \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_4.c \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_5.c \
../lvgl-8.3.10/examples/widgets/bar/lv_example_bar_6.c 

C_DEPS += \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_1.d \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_2.d \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_3.d \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_4.d \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_5.d \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_6.d 

OBJS += \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_1.o \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_2.o \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_3.o \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_4.o \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_5.o \
./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_6.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/widgets/bar/%.o: ../lvgl-8.3.10/examples/widgets/bar/%.c lvgl-8.3.10/examples/widgets/bar/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-bar

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-bar:
	-$(RM) ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_1.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_1.o ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_2.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_2.o ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_3.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_3.o ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_4.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_4.o ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_5.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_5.o ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_6.d ./lvgl-8.3.10/examples/widgets/bar/lv_example_bar_6.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-widgets-2f-bar
