...
C_SRCS += \
../lvgl-8.3.10/examples/event/lv_example_event_1.c \
../lvgl-8.3.10/examples/event/lv_example_event_2.c \
../lvgl-8.3.10/examples/event/lv_example_event_3.c \
../lvgl-8.3.10/examples/event/lv_example_event_4.c 

C_DEPS += \
./lvgl-8.3.10/examples/event/lv_example_event_1.d \
./lvgl-8.3.10/examples/event/lv_example_event_2.d \
./lvgl-8.3.10/examples/event/lv_example_event_3.d \
./lvgl-8.3.10/examples/event/lv_example_event_4.d 

OBJS += \
./lvgl-8.3.10/examples/event/lv_example_event_1.o \
./lvgl-8.3.10/examples/event/lv_example_event_2.o \
./lvgl-8.3.10/examples/event/lv_example_event_3.o \
./lvgl-8.3.10/examples/event/lv_example_event_4.o 


# Each subdirectory must supply rules for building sources it contributes
lvgl-8.3.10/examples/event/%.o: ../lvgl-8.3.10/examples/event/%.c lvgl-8.3.10/examples/event/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-event

clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-event:
	-$(RM) ./lvgl-8.3.10/examples/event/lv_example_event_1.d ./lvgl-8.3.10/examples/event/lv_example_event_1.o ./lvgl-8.3.10/examples/event/lv_example_event_2.d ./lvgl-8.3.10/examples/event/lv_example_event_2.o ./lvgl-8.3.10/examples/event/lv_example_event_3.d ./lvgl-8.3.10/examples/event/lv_example_event_3.o ./lvgl-8.3.10/examples/event/lv_example_event_4.d ./lvgl-8.3.10/examples/event/lv_example_event_4.o

.PHONY: clean-lvgl-2d-8-2e-3-2e-10-2f-examples-2f-event
